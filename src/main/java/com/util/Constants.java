...
public class Constants {
	...
	/*public static final String[] SFTypes = { "ApexClass", "ApexComponent",
		...
		"AssignmentRules", "AutoResponseRules", "Community",
		"CustomApplication", "CustomField", "CustomLabel", "CustomLabels",
		"CustomObject", "CustomObjectTranslation", "CustomTab", "EscalationRule",
		"EscalationRules", "HomePageLayout", "Layout", "ListView",
		"MatchingRules", "MatchingRules", "Profile", "PermissionSet",
		"QuickAction", "RemoteSiteSetting",  "ReportType",
		"Settings", "SharingRules", "StaticResource", "WebLink",
		"CustomPageWebLink", "Workflow", "Queue", "ApprovalProcess",
		"ActionLinkGroupTemplate", "CompactLayout", "ConnectedApp",
		"CustomApplicationComponent", "CustomMetadata", "CustomPermission",
	...
	// public static final String[] SFTypes = { "FlowDefinition"};
